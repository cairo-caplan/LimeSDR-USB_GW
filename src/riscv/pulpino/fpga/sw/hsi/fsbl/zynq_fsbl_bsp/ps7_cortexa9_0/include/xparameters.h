...
/* Definitions for peripheral AXI_GPIO_EMU */
#define XPAR_AXI_GPIO_EMU_BASEADDR 0x51030000
#define XPAR_AXI_GPIO_EMU_HIGHADDR 0x5103FFFF
#define XPAR_AXI_GPIO_EMU_DEVICE_ID 0
#define XPAR_AXI_GPIO_EMU_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_EMU_IS_DUAL 0


/* Definitions for peripheral AXI_JTAG_EMU */
#define XPAR_AXI_JTAG_EMU_BASEADDR 0x51020000
#define XPAR_AXI_JTAG_EMU_HIGHADDR 0x5102FFFF
#define XPAR_AXI_JTAG_EMU_DEVICE_ID 1
#define XPAR_AXI_JTAG_EMU_INTERRUPT_PRESENT 0
#define XPAR_AXI_JTAG_EMU_IS_DUAL 0


/* Definitions for peripheral AXI_PULP_CONTROL */
#define XPAR_AXI_PULP_CONTROL_BASEADDR 0x51000000
#define XPAR_AXI_PULP_CONTROL_HIGHADDR 0x5100FFFF
#define XPAR_AXI_PULP_CONTROL_DEVICE_ID 2
#define XPAR_AXI_PULP_CONTROL_INTERRUPT_PRESENT 0
#define XPAR_AXI_PULP_CONTROL_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_EMU */
#define XPAR_GPIO_0_BASEADDR 0x51030000
#define XPAR_GPIO_0_HIGHADDR 0x5103FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_EMU_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral AXI_JTAG_EMU */
#define XPAR_GPIO_1_BASEADDR 0x51020000
#define XPAR_GPIO_1_HIGHADDR 0x5102FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_JTAG_EMU_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral AXI_PULP_CONTROL */
#define XPAR_GPIO_2_BASEADDR 0x51000000
#define XPAR_GPIO_2_HIGHADDR 0x5100FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_PULP_CONTROL_DEVICE_ID
